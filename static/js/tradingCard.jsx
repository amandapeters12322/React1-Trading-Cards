...
function TradingCardContainer(){
  ...
  tradingCards.push(
    <TradingCard name={card.name} skill={card.skill} imgUrl={card.imgUrl} key={card.cardId} />
  );
  }
  return (
    <React.Fragment>
...
// ReactDOM.render(
//   <TradingCard name="Mermie" skill="blowing bubbles" imgUrl="/static/img/merge.png" />,
//   document.querySelector('#mermie')
// );

// ReactDOM.render(
//   <TradingCard name="Seedpy" skill="water skiing" imgUrl="/static/img/seedpy.jpeg" />,
